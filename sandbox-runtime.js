...
(() => {
  ...
  const seedMember4147 = tables.current_game[0]?.teams?.flat()[0];
  if(seedMember4147 && s.currentGame?.balanceBeforeResults){
    seedMember4147._balanceBeforeResults = clone(s.currentGame.balanceBeforeResults);
  }
