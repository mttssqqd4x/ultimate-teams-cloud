...
const REFACTOR_VERSION_4120 = "4.12.2";
...
function renderGameNightDashboard4120(){
  ...
  const queueCount = readOfflineAttendanceQueue4120().length;
  out.innerHTML = `
    ...
    <div class="dashboard-tile"><div class="dashboard-label">Reshuffle</div><div class="dashboard-value">${activeReshuffleMode4120().replace("maximum","Max")}</div></div>
    <div class="dashboard-tile"><div class="dashboard-label">Offline queue</div><div class="dashboard-value">${queueCount}</div>${queueCount ? '<div class="offline-queue-note">Will sync automatically</div>' : ''}</div>`;
